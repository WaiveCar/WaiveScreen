...
function chart1() {
  ...
  var ctx = document.getElementById('campaign-chart-1').getContext('2d');
...
function chart2() {
  ...
  var config = {
    ...
    data: {
      datasets: [
        {
          data: [46.21, 23.64, 14.47, 11.11, 5.71],
          backgroundColor: [
  ...
  var ctx = document.getElementById('campaign-chart-2').getContext('2d');
...
function chart3() {
  ...
  var config = {
    ...
    data: {
      datasets: [
        {
          data: [42.8, 27.1, 11.97, 10.31, 6.69],
          backgroundColor: [
            window.chartColors.yellow,
            window.chartColors.green,
            window.chartColors.purple,
    ...
    options: {
      title: {
        display: true,
        text: 'Campaign Impressions By DMA',
      },
      legend: {
        display: false,
      },
  ...
  var ctx = document.getElementById('campaign-chart-3').getContext('2d');
  let chart = new Chart(ctx, config);
}
